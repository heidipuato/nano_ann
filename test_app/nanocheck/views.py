...
def home(request):
    return render(request,"nanocheck/home.html")

def test(request):
    form = FeatureForm

    data = {"form":form}
    return render(request,"nanocheck/test.html", data)
...
def predict(request):
   ...
   print(finalans)
   return render(request, "nanocheck/result.html",{'ans':finalans,"val1":val01, "val2":val02,"val3":val03, "val4":val04,
